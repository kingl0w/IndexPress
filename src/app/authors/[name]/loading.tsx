  ...
  return (
    <div className="animate-pulse">
      ...
      <div className="mb-6 flex gap-2">
        <div className="h-4 w-12 rounded bg-stone-700" />
        <div className="h-4 w-16 rounded bg-stone-700" />
        <div className="h-4 w-28 rounded bg-stone-700" />
      </div>

      <div className="h-9 w-48 rounded bg-stone-700" />
      <div className="mt-3 h-5 w-64 rounded bg-stone-700" />
